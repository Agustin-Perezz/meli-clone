...
export const NavBar: React.FC = () => {
  ...
  const { onChange, queryProduct, reset } = useForm({
    queryProduct: initialQuery || '',
  });
    ...
    <div className="nav">
      <div className="nav__container">
        <div className="nav__block--1">
          ...
          />
          <img
            className="nav__img--desktop nav__img--xl"
            src={meli_logo_large}
            alt=""
            onClick={() => reset()}
          />
        ...
        <div className="nav__block--3">
          ...
          <ul className="nav__links nav__secondary">
            ...
            <li className="nav__link">
              {' '}
              <img src={shopping_cart} alt="" className="nav__shopping" />{' '}
            </li>
          </ul>
        </div>
      </div>
