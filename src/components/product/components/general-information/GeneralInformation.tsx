    ...
    <div className="information">
      ...
      <div className="shipping">
        <TruckIcon
          ...
          fill={basic_info.free_shipping === true ? '#00a650' : '#363636'}
        />
        <div className="shipping__group">
          <span className={`shipping__text ${basic_info.free_shipping === true && 'free'}`}>
            {' '}
            {basic_info.free_shipping === true
      ...
      <div className="seller">
        <span className="seller__label">
          {' '}
          Vendido por <label> {seller.nickname} </label>{' '}
        </span>
