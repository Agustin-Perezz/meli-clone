  ...
  return (
    <div className="payment__container">
      ...
      <div className="payment__cuotes">
        ...
        <img
          src={images.mercado_credit_url}
          alt="mercado-credito"
          className="payment__cuotes__img"
        />
      </div>
      <div className="payment__credit">
        <div className="payment__credit__header">
          ...
          <span className="payment__credit__header--subtitle">
            {' '}
            ¡Cuotas sin interés con bancos seleccionados!{' '}
          </span>
        </div>
        <div className="payment__images">
          {images.credit.map((url, index) => (
            <img src={url} key={index} alt="credit" className="payment__images__icon" />
          ))}
        </div>
      </div>
      <div className="payment__debit">
        ...
        <div className="payment__images">
          {images.debit.map((url, index) => (
            <img src={url} key={index} alt="debit" className="payment__images__icon" />
          ))}
        </div>
      </div>
      <div className="payment__efectivo">
        ...
        <div className="payment__images">
          {images.efectivo.map((url, index) => (
            <img src={url} key={index} alt="efectivo" className="payment__images__icon" />
          ))}
        </div>
      </div>
